            ...
            <div class="toolbox">
              ...
              <div class="tool"><label>Margins (mm)</label>
                <div style="display:grid; grid-template-columns: repeat(4, 1fr); gap:6px;">
                  <input id="ctl-top" type="number" min="0" value="5" />
                  <input id="ctl-right" type="number" min="0" value="5" />
                  <input id="ctl-bottom" type="number" min="0" value="5" />
                  <input id="ctl-left" type="number" min="0" value="5" />
                </div>
              </div>
