...
<head>
  ...
  <title>Duplex Printing - iskOPrint</title>
...
<body>
  ...
  <main class="container">
    <h1 class="title"><i class="fas fa-retweet"></i> Duplex Printing</h1>
    <div class="card">
      <label for="duplex">Select duplex mode</label>
      <select id="duplex">
        <option>Single-sided</option>
        <option>Double-sided (flip on long edge)</option>
        <option>Double-sided (flip on short edge)</option>
      </select>
